        ...
        <div className="max-w-7xl mx-auto px-6 py-5">
          <div className="flex justify-between items-center">
            ...
            <div className="hidden md:flex items-center space-x-8">
              <Link to="/" style={{ color: '#2D2D2D' }} className="hover:text-gray-600 transition-colors font-large font-semibold">
                Home
              </Link>
              <Link to="/about" style={{ color: '#2D2D2D' }} className="hover:text-gray-600 transition-colors font-medium font-semibold">
                About
              </Link>
              <Link to="/classes" style={{ color: '#2D2D2D' }} className="hover:text-gray-600 transition-colors font-medium font-semibold">
                Classes
              </Link>
              <button 
                className="px-5 py-3 
